...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            <h2 class="margin-bottom"><i class="bi bi-box-fill" style="color: #e63946;"></i> Pending Orders</h2>
            <p class="margin-bottom">Here are all pending orders of the customers.</p>
